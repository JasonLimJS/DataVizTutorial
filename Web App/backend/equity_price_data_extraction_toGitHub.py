...
while start_index<6510:
    for tic_iter in range(start_index,end_index):
        ...
        for index, row in eq_df.iterrows():
            sql_stat= return_sql_stat(row[eq_df_columns[0]].strftime('%Y-%m-%d'), row[eq_df_columns[1]], row[eq_df_columns[2]], row[eq_df_columns[3]], row[eq_df_columns[4]], 
                                      row[eq_df_columns[5]], row[eq_df_columns[6]], row[eq_df_columns[7]], row[eq_df_columns[8]],row[eq_df_columns[9]], row[eq_df_columns[10]],
                                      row[eq_df_columns[11]], row[eq_df_columns[12]], row[eq_df_columns[13]], row[eq_df_columns[14]],row[eq_df_columns[15]], 
